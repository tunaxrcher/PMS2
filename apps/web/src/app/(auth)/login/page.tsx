    ...
    <>
      ...
      <AppBackground>
        <div className="flex min-h-screen items-center justify-center p-4">
          ...
          >
            <p className="mb-2 text-center text-xs text-stone-700">For Development</p>
            <div className="grid grid-cols-3 gap-2">
              {[
                ...
                >
                  ...
                  <span className="text-xs font-medium leading-none">{role}</span>
                </motion.button>
              ))}
            </div>
          </motion.div>

          <motion.p className="mt-3 text-center text-xs text-stone-700"
