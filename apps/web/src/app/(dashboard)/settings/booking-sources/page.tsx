...
export default function BookingSourcesPage() {
  ...
  const handleSubmit = () => {
    ...
    if (editId) updateMutation.mutate({ id: editId, data: form as unknown as Record<string, unknown> })
    else createMutation.mutate(form as unknown as Record<string, unknown>)
  }
