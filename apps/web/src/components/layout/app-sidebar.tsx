        ...
        <nav className="flex-1 overflow-y-auto py-4 px-3">
          {navSections.map((section) => (
            <div key={section.label} className="mb-5">
              {!sidebarCollapsed && (
                <div className="mb-2 px-2 text-xs font-semibold uppercase tracking-widest text-stone-600">
                  {section.label}
                </div>
              )}
                  ...
                  return (
                    ...
                    >
                      ...
                      {!sidebarCollapsed && item.badge != null && item.badge > 0 && (
                        <span className="ml-auto rounded-full bg-amber-400/25 px-2 py-0.5 text-xs font-semibold text-amber-300">
                          {item.badge}
                        </span>
                      )}
                    </Link>
